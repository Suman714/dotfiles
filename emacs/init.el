...
(custom-set-variables
 ...
 '(package-selected-packages
   '(vterm zen-mode harpoon frontside-javascript forge magit general which-key utop typescript-mode rust-mode pyvenv python-mode no-littering merlin lsp-ui lsp-ivy ivy-rich go-mode fzf evil dap-mode counsel company clojure-mode auto-package-update)))
(custom-set-faces
